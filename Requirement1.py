# -*- coding: utf-8 -*-
"""Lab 10 Colab practice and requirements.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1nI2oMLnqCd4dOsberCdmiquqzi-y6ZbZ
...
class MathOperations:
  ...
  def test_is_prime(self):
    assert self.is_prime(2) == True
    assert self.is_prime(7) == True
    assert self.is_prime(10) == False
    assert self.is_prime(-1) == False
    assert self.is_prime(0) == False
    assert self.is_prime(1) == False
    print("Success")
